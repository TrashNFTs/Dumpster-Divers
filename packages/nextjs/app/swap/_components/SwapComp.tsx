...
import {
  ...
  // useMe2,
  useReadApproves,
  useReadOwnerOfsDumpsterDivers,
  useReadOwnerOfsTrash,
...
export function SwapComp() {
  ...
  // console.log(jsonsOfOwnedDumpsterDiversOfWallet);
          ...
          >
            ...
            <TabPanel>
              <p className="text-center">
                ...
                <br />
                (just pay a wee fee of 0.00042069 ETH per Dumpster Diver re-trashed)
              </p>
